...
namespace Midas.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260519121941_AddNovaPoshtaWerehousesCities")]
    partial class AddNovaPoshtaWerehousesCities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Midas.Core.Products.Product", b =>
                {
                    ...
                    b.Property<string>("ContactPersonRecipient")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("contact_person_recipient");
            ...
            modelBuilder.Entity("Midas.Core.UserIntegrations.Midas.Core.UserIntegrations.UserSenderAddress", b =>
                {
                    b.HasOne("Midas.Core.UserIntegrations.UserLogisticProfile", "UserLogisticProfile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_sender_address_user_logistic_profile_user_logistic_pro");
