...
{
    public class AddProductToWarehouseCommand : ICommand<Warehouse>
    {
    ...
    {
        public async Task<Warehouse> Handle(AddProductToWarehouseCommand request, CancellationToken cancellationToken)
        {
